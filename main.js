...
function myKeyDown(e)
{
	...
	function up()
	{
		if(ballY>450){
			...
			console.log("quando a tecla cima é pressionada, X = " + ballX + ", Y = "+ ballY);
			canvas.remove(ballObj);
			newImage();
		}
	}
	...
	function down()
	{
		if(ballY<=450){
			ballY = ballY + blockImageHeight;
			console.log("altura da imagem do bloco = " + blockImageHeight);
			console.log("quando a tecla baixo é pressionada, X = " + ballX + ", Y = "+ ballY);
			canvas.remove(ballObj);
			newImage();
		}
	}
	...
	function left()
	{
		if(ballX >5)
		{
			...
			console.log("quando a tecla esquerda é pressionada, X = " + ballX + ", Y = "+ ballY);
			canvas.remove(ballObj);
			newImage();	
		}
	}
	...
	function right()
	{
		if(ballX <=1050)
		{
			ballX = ballX + blockImageWidth;
			console.log("largura da imagem do bloco = " + blockImageWidth);
			console.log("quando a tecla direita é pressionada, X = " + ballX + ", Y = "+ ballY);
			canvas.remove(ballObj);
			newImage();	
		}
	}
